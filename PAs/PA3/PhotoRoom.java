...
/**
 * PhotoRoom class implements the MessageExchange interface to add, remove, retrieve information
...
public class PhotoRoom implements MessageExchange {
    ...
    /**
     * Method that adds users only if they're premium users
     *
     * @param u: User to add
     * @return true when the user, u, is added; false when user can't be added
     */
    ...
    public boolean recordMessage(Message m) {
        // only PhotoMessage messages will be recorded
